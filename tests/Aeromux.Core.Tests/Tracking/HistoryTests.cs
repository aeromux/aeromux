    ...
    public class HistoryTests : AircraftStateTrackerTestsBase
    {
        ...
        public void Update_PositionHistory_FillsCircularBufferCorrectly()
        {
            ...
            for (int i = 0; i < 150; i++)
            {
                ...
                _tracker.Update(CreateFrame(RealFrames.AirbornePos_80073B_Odd, "80073B", parser));
            }
        ...
        public void Update_AltitudeHistory_TracksBarometricAltitude()
        {
            ...
            // Act
            _tracker.Update(CreateFrame(RealFrames.AirbornePos_80073B_Even, "80073B"));
            _tracker.Update(CreateFrame(RealFrames.AirbornePos_73806C_Even, "73806C"));

            // Assert
            Aircraft? aircraft1 = _tracker.GetAircraft("80073B");
            Aircraft? aircraft2 = _tracker.GetAircraft("73806C");
