...
namespace Aeromux.Core.Tests.Tracking
{
    ...
    {
        [Fact]
        public void ThreadSafety_ConcurrentUpdatesToSameAircraft_NoExceptionsAllUpdatesCount()
        {
            // Arrange
        ...
        [Fact]
        public void ThreadSafety_ConcurrentUpdatesToDifferentAircraft_NoContamination()
        {
            // Arrange
            _tracker = CreateTracker();
        ...
        [Fact]
        public void ThreadSafety_ConcurrentReadsDuringUpdates_NoExceptions()
        {
            // Arrange
            _tracker = CreateTracker();
            ...
            Task.WaitAll(readerTasks.Concat(updaterTasks).ToArray());
        ...
        [Fact]
        public void ThreadSafety_ConcurrentGetAircraftLookups_NoExceptions()
        {
            // Arrange
            _tracker = CreateTracker();
            ...
            Task.WaitAll(lookupTasks.Concat(updateTasks).ToArray());
        ...
        [Fact]
        public void ThreadSafety_DuringExpirationCleanup_NoDeadlocks()
        {
            // Arrange
        ...
        [Fact]
        public void ThreadSafety_RaceConditionBetweenUpdateAndExpiration_NoCorruption()
        {
            // Arrange
            _tracker = CreateTrackerWithTimeout(timeoutSeconds: 1);
        ...
        [Fact]
        public void ThreadSafety_ConcurrentEventHandlers_NoDataCorruption()
        {
            // Arrange
            _tracker = CreateTracker();
            int addedCount = 0;
        ...
        [Fact]
        public void ThreadSafety_StressTest_1000ConcurrentOperations()
        {
            // Arrange
            _tracker = CreateTracker();
