...
|---------------|----------------------------------------------------|
| Package       | `aeromux`                                          |
| Version       | From `src/Directory.Build.props` (e.g., `0.7.5-1`) |
| Section       | `misc`                                             |
| Priority      | `optional`                                         |
...
The version string follows Debian conventions: `<upstream-version>-<debian-revision>` (e.g., `0.7.5-1`). The upstream version is read from `src/Directory.Build.props` at packaging time.
...
```bash
sudo dpkg -i aeromux_0.7.5-1_arm64.deb
```
